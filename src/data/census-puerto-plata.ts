...
export const CENSUS_SECTORS: CensusSector[] = [
  ...
  { id: 'pp_centro', name: 'Centro Histórico / Parque Central', municipio: 'Puerto Plata', center: { lat: 19.797, lon: -70.687 }, radiusKm: 0.9, purchasingPower: 0.55, povertyRate: 34.5, dataQuality: 'sourced' },
  ...
  { id: 'pp_barrios_sur', name: 'Barrios del Sur (San Marcos / Padre Las Casas)', municipio: 'Puerto Plata', center: { lat: 19.78, lon: -70.7 }, radiusKm: 1.5, purchasingPower: 0.35, povertyRate: 36.2, dataQuality: 'sourced' },
  ...
  { id: 'maimon', name: 'Maimón / Amber Cove', municipio: 'Puerto Plata', center: { lat: 19.799, lon: -70.758 }, radiusKm: 1.2, purchasingPower: 0.5, povertyRate: 34.0, dataQuality: 'sourced' },

  // ── Sosúa (turismo y residencial internacional) ──
  { id: 'sosua_batey', name: 'Sosúa El Batey (centro turístico)', municipio: 'Sosúa', center: { lat: 19.752, lon: -70.512 }, radiusKm: 0.9, purchasingPower: 0.8, povertyRate: 35.1, dataQuality: 'sourced' },
  ...
  { id: 'sosua_abajo', name: 'Sosúa Abajo / residencial', municipio: 'Sosúa', center: { lat: 19.757, lon: -70.535 }, radiusKm: 1.0, purchasingPower: 0.62, povertyRate: 37.0, dataQuality: 'sourced' },

  // ── Cabarete (distrito de Sosúa · turismo deportivo) ──
  { id: 'cabarete_playa', name: 'Cabarete Centro / Playa (kitesurf)', municipio: 'Cabarete (Sosúa)', center: { lat: 19.758, lon: -70.409 }, radiusKm: 1.0, purchasingPower: 0.78, povertyRate: 38.9, dataQuality: 'sourced' },
  { id: 'cabarete_loma', name: 'Callejón de la Loma / Islabón', municipio: 'Cabarete (Sosúa)', center: { lat: 19.75, lon: -70.42 }, radiusKm: 0.8, purchasingPower: 0.4, povertyRate: 42.7, dataQuality: 'sourced' },
  ...
  { id: 'villa_isabela', name: 'Villa Isabela', municipio: 'Villa Isabela', center: { lat: 19.817, lon: -71.067 }, radiusKm: 1.2, purchasingPower: 0.28, povertyRate: 44.7, dataQuality: 'sourced' },
