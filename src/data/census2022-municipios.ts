...
const MUNICIPIOS_2022: Record<string, MunicipioPop[]> = {
  'santo-domingo': [
    { name: 'Distrito Nacional (Sto. Dgo. de Guzmán)', population: 1_029_110, viviendas: 363_153, urbanPct: 100 },
    {
    ...
    { name: 'Santo Domingo Oeste', population: 410_578, viviendas: 142_564, urbanPct: 78 },
    {
      name: 'Los Alcarrizos',
      population: 336_307,
      viviendas: 111_414,
    ...
    { name: 'San Antonio de Guerra', population: 59_299, viviendas: 20_659, urbanPct: 29 },
  ],
  'puerto-plata': [
    { name: 'Puerto Plata', population: 162_093, viviendas: 58_937, urbanPct: 84 },
    {
      name: 'Sosúa',
      population: 56_982,
      viviendas: 20_874,
    ...
    { name: 'Imbert', population: 22_925, viviendas: 8_773, urbanPct: 32 },
    { name: 'Villa Montellano', population: 20_753, viviendas: 7_675, urbanPct: 56 },
    { name: 'Villa Isabela', population: 20_278, viviendas: 6_970, urbanPct: 40 },
    { name: 'Altamira', population: 17_676, viviendas: 7_127, urbanPct: 25 },
    { name: 'Luperón', population: 17_577, viviendas: 6_467, urbanPct: 35 },
    { name: 'Los Hidalgos', population: 13_605, viviendas: 4_796, urbanPct: 24 },
    { name: 'Guananico', population: 6_466, viviendas: 2_434, urbanPct: 41 },
  ],
  'la-altagracia': [
    {
      name: 'Higüey',
  ...
  'san-cristobal': [
    ...
    { name: 'San Gregorio de Nigua', population: 38_272, viviendas: 12_410, urbanPct: 46 },
    {
    ...
    { name: 'Sabana Grande de Palenque', population: 18_304, viviendas: 5_646, urbanPct: 32 },
    { name: 'Los Cacaos', population: 13_778, viviendas: 3_963, urbanPct: 24 },
  ],
  'santiago': [
    {
    ...
    { name: 'Bisonó (Navarrete)', population: 49_367, viviendas: 17_111, urbanPct: 76 },
    {
      name: 'Puñal',
      population: 46_090,
      viviendas: 15_524,
    ...
    { name: 'Villa González', population: 42_198, viviendas: 14_354, urbanPct: 42 },
    { name: 'San José de Las Matas', population: 37_411, viviendas: 12_893, urbanPct: 28 },
    {
      name: 'Licey al Medio',
      population: 30_103,
      viviendas: 9_724,
    ...
    { name: 'Jánico', population: 14_385, viviendas: 5_172, urbanPct: 24 },
    { name: 'Sabana Iglesia', population: 14_018, viviendas: 5_165, urbanPct: 35 },
  ...
  'la-romana': [
    ...
    { name: 'Guaymate', population: 17_228, viviendas: 5_215, urbanPct: 45 },
  ],
};
