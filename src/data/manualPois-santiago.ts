 ...
 *
 * Vacío por ahora: agregar aquí establecimientos verificados de Santiago
 * (Santiago de los Caballeros, Tamboril, Navarrete…) con coordenadas
 * confirmadas por el usuario, siguiendo el mismo patrón usado en Puerto Plata.
 */
