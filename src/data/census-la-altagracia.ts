...
export const CENSUS_SECTORS: CensusSector[] = [
  ...
  { id: 'higuey_barrios_sur', name: 'Barrios del Sur (Cuesta del Rayo / Buenos Aires)', municipio: 'Higüey', center: { lat: 18.6, lon: -68.715 }, radiusKm: 1.4, purchasingPower: 0.32, povertyRate: 60.6, dataQuality: 'sourced' },
  ...
  { id: 'bavaro_centro', name: 'Bávaro Centro (Los Corales)', municipio: 'Verón-Punta Cana', center: { lat: 18.682, lon: -68.42 }, radiusKm: 1.3, purchasingPower: 0.62, povertyRate: 55.3, dataQuality: 'sourced' },
  { id: 'bavaro_resorts', name: 'Bávaro Resorts / Playa Bávaro', municipio: 'Verón-Punta Cana', center: { lat: 18.7, lon: -68.4 }, radiusKm: 1.3, purchasingPower: 0.85, povertyRate: 55.3, dataQuality: 'sourced' },
