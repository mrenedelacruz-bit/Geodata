 ...
 *
 * Vacío por ahora: agregar aquí establecimientos verificados de La Altagracia
 * (Higüey, Punta Cana, Bávaro, Bayahibe…) con coordenadas confirmadas por el
 * usuario, siguiendo el mismo patrón usado en Puerto Plata.
 */
